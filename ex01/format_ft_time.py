...
decimal_anotation = "{:,.4f}".format(time.time())
scientific_anotation = "{:.2e}".format(time.time())
...
formatted_date = datetime.fromtimestamp(time.time(), tz=timezone.utc).strftime('%b %d')
